...
public interface UserFeignClient {
    ...
    @GetMapping("/{id}/minbalance/{cost}") //TODO repensar si esto es un path variable o query param
    boolean hasSufficientBalance(@PathVariable long id,@PathVariable double cost);

    @PostMapping("/{id}/deduct/{cost}") //TODO repensar si esto es un path variable o query param
